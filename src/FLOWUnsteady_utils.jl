...
function plot_maneuver(maneuver::DynamicManeuver;
    ...
    fig1 = figure(figname*"-dynamics", figsize=[7*3, 5*1]*size_factor;
                                                        constrained_layout=true)
    axs1 = fig1.subplots(1, 3)

    # fig1.tight_layout()
    fig1.suptitle("VEHICLE DYNAMICS")
    ...
    ax.set_xlabel("dimensional time")
    ax.set_ylabel("dimensional velocity")
...
"""
function visualize_kinematics(sim::Simulation{V, DynamicManeuver{N, M}, R},
